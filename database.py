...
class Opportunity(Flag):
    ...
    NOTIFICATION = 2 ** 11
    TRACKED_WORDS_NOTIFICATION = 2 ** 12

    USER = 0
    ADMIN = NO_MESSAGE_DELAY | NO_DELETE_RESTRICTIONS | DELETE_OTHERS_MESSAGES
    MODERATOR = ADMIN | CAN_SEE_USERNAMES | CAN_RECEIVE_USER_JOINED_BANNED_MESSAGE | CAN_SEE_POLL_INFO | NOTIFICATION
    OWNER = (MODERATOR | NO_CONTENT_PROTECTION | MUTE_BAN_ADMINS | READ_PRIVATE_MESSAGES
             | SILENT_MUTE_BAN | CAN_SEE_DELETED_MESSAGES | TRACKED_WORDS_NOTIFICATION)
