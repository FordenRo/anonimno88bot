...
from database import User, Opportunity, DelayedMessage, RealMessage, FakeMessage
...
def command(message: Message, user: User):
    ...
    for fake_message: FakeMessage in reply_to.fake_messages:
        try:
